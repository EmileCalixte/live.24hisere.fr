 ...
 */
export function getCategoryCodeFromBirthYear(birthYear: number | string): CategoryShortCode {
...
export function getCategoryNameFromBirthYear(birthYear: number | string): string {
