  ...
  const harmonizeNames = (): void => {
    setRunnersToImport((runners) =>
      runners.map(({ runner, ...params }) => ({
        ...
        runner: {
          ...runner,
          firstname: runner.firstname ? stringUtils.harmonizeName(runner.firstname) : "",
          lastname: runner.lastname ? stringUtils.harmonizeName(runner.lastname) : "",
        },
      })),
    );
  };
  ...
  return (
    <Page id="admin-import-runners-csv" htmlTitle="Import de coureurs">
      ...
      <Row className="row-cols-auto">
        <Col>
          <Input label="Fichier CSV" type="file" onChange={onFileInputChange} accept=".csv" inputRef={fileInputref} />
        </Col>
      </Row>
            ...
            <Col>
              <Card>
                  ...
                  <Col>
                    <div className="d-flex">
                      <div className="flex-grow-1">
                        <button className="button" onClick={harmonizeNames}>
                ...
                <Row>
                  <Col>
                    <p className="mb-0">
                      {runnersToImportCount}/{runnersFromCsvCount} coureur
                      {runnersToImportCount > 1 ? "s" : ""}{" "}
                      {runnersToImportCount > 1 ? "seront importés" : "sera importé"}
                    </p>
                  </Col>
                </Row>
